...
const Signin = () => {
  ...
  return (
    <div className="flex justify-center  ">
      <div className="mt-7 w-[50vh] shadow-xl bg-white border border-gray-200 rounded-xl  dark:bg-neutral-900 dark:border-neutral-700">
                ...
                <div className="flex items-center">
                  <div className="flex">
                    <input
                      ...
                      name="remember-me"
                      type="checkbox"
                      className="shrink-0 mt-0.5 border-gray-200 rounded border-[1px] text-blue-600 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
                    />
                  </div>
                  <div className="ms-3">
                    <label
